#' The CDranking function
#'
#' This function is designed to calculate CDranking.
#'
#' @param K A numeric matrix of kinship.
#'
#' @return This function will return each individuals' CDranking values.
#'
#' @export
#' @examples
#' data(kinship)
